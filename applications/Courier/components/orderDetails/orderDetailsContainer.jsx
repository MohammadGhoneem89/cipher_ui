              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="orderno">
                    <img src="assets/imgs/ordericon.png" width="18px"/><label className="bold">Order
                  ...
                  <div className="shadowBox Courierbox">
                    <div className="row">
                      ...
                      <div className="col-md-6 text-center">
                        ...
                        <div><img src="assets/imgs/dhl.png" width="10%"/></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="shadowBox squarebox">
                    <div className="portletheading">
                      ...
                      <div className="titleicon"><img src="assets/imgs/soldTo.png"/></div>
                    </div>
                ...
                <div className="col-md-4">
                  <div className="shadowBox squarebox">
                    <div className="portletheading">
                      ...
                      <div className="titleicon billto"><img src="assets/imgs/Billto.png"/></div>
                    </div>
                    <div className="boxBody">
                      <div className="form-group">
                        <div className="row">
                ...
                <div className="col-md-4">
                  <div className="shadowBox squarebox">
                    <div className="portletheading">
                      ...
                      <div className="titleicon shipto"><img src="assets/imgs/shipto.png"/></div>
                    </div>
                    <div className="boxBody">
                      <div className="form-group">
                        <div className="row">
                  ...
                  <div className="tab-pane in active">
                    <div className="ui-regulartabs">
                      <ul id="adHocTabs" className="nav nav-tabs">
                        <li id="fieldsTabLink" className="active"><a href="#OrderLine" data-toggle="tab"> <span> Order Line</span></a>
                        </li>
