...
class SampleDetailPage extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      fieldName:false,
      CustomMapping:false,
      MappingFunctionName:false,
      CustomMappingFile:false,
      Asynchronous:false,
      requestServiceQueue:false,
      ServiceIP:false,
      responseQueue:false,
      ServicePort:false,
      isSimulated:false,
...
SampleDetailPage.propTypes = {
  ...
  APIDefinationAddUpdate: PropTypes.object,
};
...
function mapStateToProps(state, ownProps) {
  return {
    ...
    APIDefinationAddUpdate: state.app.APIDefinationAddUpdate,
  };
}
