                                            ...
                                            <div className="row">
                                                <div className="col-md-7">
                                                    ...
                                                    <div className="col-md-2">
                                                        <button style={{ width: '100%' }} type="button" className="btn default" >
                                                            Add
                                        </button>
                                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="portlet">
                                                ...
                                                <div className="portlet-body">
                                                    <div className="portlet light bordered sdg_portlet" style={{ marginTop: "50px" }}>
                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="portlet light bordered sdg_portlet">
                                                ...
                                                <div className="portlet-body">
                                                    <div className="row spread-items">
                                            ...
                                            <div className="portlet light bordered sdg_portlet">
                                                ...
                                                <div className="portlet-body">
                                                    <div className="row spread-items">
                                                        ...
                                                        <img width="40px" height="40px" src="/assets/imgs/smiles.jpg"  />
                                                        </div>
                                                        <div className="col-md-8">
                                                            <Input isValid={this.state.valid}
                                                                        //validationChecker={this.validationHandler} 
                                                                        required={true}
                                                                        fieldname="fromOpeningHours" formname="addShop" state={this.state}
                                                                        //errorMessage={'This field is required'}
