                                ...
                                <div className="row">
                                        ...
                                        <div className="row">
                                                ...
                                                <div className="col-md-3 text-center">
                                                    <div className="voucherBox">                                                  
                                                        <div className="areacard">
                                                            <img src="../../../../../images/etihad.png" style={{ width: "145px" }} />
                                                            <p>Membership Number</p>
                                                            <p>{this.state.transactionData.membershipNo}</p>
                                                            <p><strong>100 Smiles</strong></p>
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div className="col-md-3 text-center">
                                                    <div className="voucherBox">                                                  
                                                        <div className="areacard">
                                                            <img src="../../../../../images/smiles.png" style={{ width: "52px" }} />
                                                            <p>Membership Number</p>
                                                            <p>{this.state.transactionData.membershipNo}</p>
                                                            <p><strong>100 Smiles</strong></p>
                                                        </div>
