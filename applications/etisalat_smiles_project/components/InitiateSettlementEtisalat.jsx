...
class InitiateSettlementEtisalat extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <Portlet title={"Initiate Settlement Etisalat"}>
                <div className="row">
                ...
                <div className="row">
                    ...
                    <div className="row">
                        <div className="settlementDiv">
                            <div className="row">
                                <div className="col-md-8" style={{paddingLeft:"30px"}}>POINT CONVERSION ETIHAD</div>
                                <div className="col-md-4"><img src="/assets/imgs/smiles.jpg"  className="settlementDivImage pull-right"/></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="settlementDiv">
                            <div className="row">
                                <div className="col-md-8" style={{paddingLeft:"30px"}}>ACCURAL COMMERCIAL BANK OF DUBAI</div>
                                <div className="col-md-4"><img src="/assets/imgs/smiles.jpg"  className="settlementDivImage pull-right"/></div>
                            </div>
                        </div>
                    </div>
...
InitiateSettlementEtisalat.displayName = "Initiate Settlements Etisalat";
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(InitiateSettlementEtisalat);