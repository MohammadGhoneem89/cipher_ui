                ...
                <Portlet title={utils.getLabelByID('Order List Filter(s)')}>
                    ...
                    <Row>
                        <Col col="6">
                            ...
                            <Input fieldname="contractID" formname="orderSearch" columns="8" state={this.state} actionHandler={this.generalHandler} className="form-control" />
                        </Col>
                        <Col col="6">
                            <Label text={utils.getLabelByID('Order ID')} columns="4" />
                            <Input fieldname="orderID" formname="orderSearch" columns="8" state={this.state} actionHandler={this.generalHandler} className="form-control" />
                        </Col>
                    </Row>
                    <Row>
                        <Col col="6">
                            <Label text={utils.getLabelByID('Order Status')} columns="4" />
                            <Combobox fieldname="orderStatus" formname="orderSearch" columns="8" state={this.state} typeName="Status" dataSource={this.state.typeData} actionHandler={this.generalHandler} className="form-control" />
                        </Col>
                    </Row>
