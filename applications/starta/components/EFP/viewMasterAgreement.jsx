                                    ...
                                    <form className="form-horizontal" role="form">
                                        <div className="form-body" style={{ paddingLeft: "18px" }}>
                                            ...
                                            <div className="col-md-4" style={{ paddingLeft: "90px" }}>
                                                <img className="img-thumbnail img-rounded" style={{ height: "200px", width: "200px" }} src={this.props.getMasterAgreementView[0].logo} />
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                                ...
                                                <div className="" style={{ marginTop: "24px" }}>
                                                    <div className="col-md-12 orderdetail-txt">
                                                        ...
                                                        <div className="col-md-12 text-center">
                                                            ...
                                                            {(Math.round(this.props.getMasterAgreementView[0].totalRebate)).toLocaleString()}</h4>
                                                        </div>
                                            ...
                                            <div className="table100 ver1 m-b-110" >
                                                ...
                                                <div className="" style={{ marginTop: "24px" }}>
                                                    <div className="col-md-12 orderdetail-txt">
                                                        ...
                                                        <div className="col-md-12 text-center">
                                                            <h4 style={{ fontWeight: "800", padding: "26px", fontSize: "32px" }}>{(Math.round(this.props.getMasterAgreementView[0].totalPenalty)).toLocaleString()}</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
