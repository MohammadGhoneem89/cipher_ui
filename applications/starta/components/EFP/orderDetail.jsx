                                    ...
                                    <div className="order-content">
                                        <div className="order-delay-card">
                                            ...
                                            {(this.state.userType == "SUPPLIER" ||
                                                ...
                                                < div className="row">
                                                    <div className="col-md-12 " style={{ marginTop: "20px", display: this.state.isInv == true ? 'block' : 'none' }}>
                                                                ...
                                                                <div className="" style={{ marginTop: "24px" }}>
                                                                    <div className="col-md-12 orderdetail-txt">
                                                                        ...
                                                                        <div className="col-md-12 text-center">
                                                                            <h4 style={{ fontWeight: "800", padding: "26px", fontSize: "32px" }}>{this.state.orderDetail.orderAmount}</h4>
                                                                        </div>
                                                            ...
                                                            <div className="table100 ver1 m-b-110" >
                                                                ...
                                                                <div className="" style={{ marginTop: "24px" }}>
                                                                    <div className="col-md-12 orderdetail-txt">
                                                                        ...
                                                                        <div className="col-md-12 text-center">
                                                                            <h4 style={{ fontWeight: "800", padding: "26px", fontSize: "32px" }}>{this.state.orderDetail.penalty}</h4>
                                                                        </div>
                                                            ...
                                                            <div className="table100 ver1 m-b-110" >
                                                                ...
                                                                <div className="" style={{ marginTop: "24px" }}>
                                                                    <div className="col-md-12 orderdetail-txt">
                                                                        ...
                                                                        <div className="col-md-12 text-center">
                                                                            <h4 style={{ fontWeight: "800", padding: "26px", fontSize: "32px" }}>{this.state.orderDetail.orderAmount - this.state.orderDetail.penalty}</h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
...
OrderDetail.displayName = "__ORDDET";
