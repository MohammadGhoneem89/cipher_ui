...
class InnerGrid extends React.Component {
  ...
  render() {
      console.log("this.props.showUpZone in innergrid >> ",this.props.showUpZone)
                  ...
                  <thead className="flip-content">
                    <tr>
                      {this.props.gridColumns.map((sd, index) => {
                        return (
                          <th key={index.toString()} className="text">
                            {" "}
                            {utils.getLabelByID(sd.alias)}{" "}
                          </th>
                        );
                      })}
                    </tr>
