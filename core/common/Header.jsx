...
class Header extends React.Component {
  ...
  getNotificationCount() {
    try {
      return this.props.notifications.pageData.totalRecords || 0
            ...
            <ul className="nav navbar-nav pull-right">
              ...
              <li className="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <ul className="dropdown-menu-list scroller" style={{overflowY: "scroll", "height": "250px"}}
                        data-handle-color="#637283">

                      {
                        this.props.notifications.data && this.props.notifications.data.map((sd, index) => (
