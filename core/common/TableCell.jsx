...
class TableCell extends React.Component {
    ...
    render() {
        ...
        switch (this.props.type) {
            ...
            case "image1":
                if (this.props.url) {
                    return (<td className="ent_nme"
                                style={{width: this.props.columnWidth, height: this.props.columnHeight}}><img
                        width="28px" height="28px"
            ...
            case "editableColumn":
                return (<td><input type="text" className="form-control" value={this.props.cellData.value}
                                   onChange={this.onChangeEditColumn.bind(this, this.props.searialNo)}/></td>);
            case "imageBig":
                return (
                    <td className="ent_nme" align="center" style={{width: this.props.columnWidth, paddingLeft: "50%"}}>
                        <img
            ...
            case "object":
                ...
                return (
                    <td style={{fontWeight: fontWeightStyle}}> {_.get(this.props.cellData, this.props.colMeta.property, '')} </td>);
            default:
