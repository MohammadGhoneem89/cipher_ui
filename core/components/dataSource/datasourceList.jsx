      ...
      return (
        <div>
          ...
          <Portlet title={utils.getLabelByID("DatasourceList")} isPermissioned={true}
            ...
            <Table fontclass="" gridColumns={utils.getGridColumnByName("DatasourceListData")}
                   gridData={this.props.DatasourceListData.data.searchResult}
                   totalRecords={this.props.DatasourceListData.pageData.totalRecords}
