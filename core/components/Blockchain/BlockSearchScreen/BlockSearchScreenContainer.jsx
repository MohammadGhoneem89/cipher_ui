...
class BlockSearchContainer extends React.Component {
    constructor(props, context) {
        ...
        this.state = {
            filterCriteria: props.blockNumber? {blockNumber: props.blockNumber} :{blockNumber: "latest"},
    ...
    componentDidMount() {
        window.scrollTo(0, 0);
        this.props.actions.generalProcess(constants.getTxByBlock, {
            action: "getTxByBlock",
            ...
            <div>
                ...
                {this.state.searchResult &&<Portlet title={"Transactions"}>
                    <Table
                        ...
                        gridColumns={utils.getGridColumnByName("blockTransactions")}
