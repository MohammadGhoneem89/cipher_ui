  ...
  return (
    ...
    <div>
              ...
              <div className="row">
                ...
                <div className="col-md-12">
                  <div className="col-md-3">
                    ...
                    <input type="text" className="form-control" disabled={state.readOnly} value={state.welcomeEmail}
                           name="welcomeEmail" id="welcomeEmail" onChange={onInputChange}/>
                  </div>
                  <div className="col-md-3">
                    <DropdownInput name="apiGroup" options={containerState.groupTypeListAPI}
                                   label={utils.getLabelByID("Group for API user")}
                                   disabled={state.readOnly}
                    />
                  </div>
                  <div className="col-md-3">
                    <DropdownInput name="userGroup" options={containerState.groupTypeListUI}
                                   label={utils.getLabelByID("Group for UI user")}
                                   disabled={state.readOnly}
                    />
                  </div>
                  <div className="col-md-3">
                    <DropdownInput name="firstScreen" options={containerState.typeData.First_Screens}
      ...
      },
      {
        ...
        containerProps={containerProps} containerState={containerState} welcome={welcome}
