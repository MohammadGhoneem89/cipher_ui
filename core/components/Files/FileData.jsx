        ...
        if (!this.state.isLoading) {
            ...
            return (
                <div>
                    ...
                    <Portlet title="File Stats">
                        <div className="row">
                            <TileUnit data={[{
                                "id": 1,
                                "title": "Total",
                                "value": this.state.fileData.length,
                                "actionURI": "",
                                "overDue": "",
                                ...
                                "id": 2,
                                "title": "Under Process",
                                "value": this.state.under_process,
                                "actionURI": "",
                                "overDue": "",
                                "fontClass": "green-turquoise",
                                "percentageTag": false
                            }, {
                                "id": 3,
                                "title": "Failed",
                        ...
                        <Row>
                            <Col col="6">
                                ...
                                <Combobox fieldname='status' formname='searchCriteria' columns='8' style={{}}
                                          ...
                                          dataSource={this.state.typeData} multiple={false}
...
FileData.displayName = "File Detail";
