            ...
            <div className="note note-documentation">
              <div className="row">
                ...
                <div className="col-md-9">
                  ...
                  <div className="col-md-12">
                    <p><b> Authorization:</b> {initialValues.authorization}</p>
                  </div>
                  <div className="col-md-12">
                ...
                <div style={{
                  ...
                  >
                    <div className="btn-toolbar pull-right">
                      <a className="btn dark uppercase " onClick={onLoadSample} href="javascript:;"> Load Sample
                        Request </a>
                      <a className="btn dark uppercase"
                         onClick={onRunApi.bind(this, `${baseurl}/API/${useCase}/${route}`, request)}
