          ...
          {isOwner &&
            <div>
              ...
              <div className="col-md-6">
                <div className="form-group">
                  <label className="form-group control-label col-md-4" style={{
                    textAlign: "left",
                    fontWeight: "normal"
                  }}>{utils.getLabelByID("description arabic")}</label>
                  <div className="form-group col-md-8">
                    <textarea type="text" disabled={!isOwner} className="form-control" id="descriptionAr" rows="4"
                      style={{ resize: "none", width: "100%", textAlign: "right" }} />
                  </div>
                </div>
              </div>
              ...
              <div className="col-md-6">
                <p><b>Note:</b>
                  <ul>
                    <li><i> the controller is expecting error fields to be passed either in object '__result' or directly as errorCode and options</i></li>
                    <li><i>  options is a string array and place holders should be put as %s </i></li>
                  </ul>
                </p>
              </div>
            </div>
