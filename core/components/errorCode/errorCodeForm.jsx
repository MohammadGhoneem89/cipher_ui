...
const ErrorCodeForm = ({onInputChange, addPeer, state, ActionHandlers, flag}) => {
          ...
          <div className="col-md-6">
            <div className="form-group">
              ...
              <div className="form-group col-md-8">
                <input type="text" className="form-control" id="code" onChange={onInputChange} disabled={flag}
                       value={state.code}/>
              </div>
            </div>
          </div>
