            ...
            <Row>
                <Col col='6'>
                    ...
                    <div >
                        ...
                        <Label text={_.get(containerState, 'userDetail.userType', '') === '' ? "Please Sel ect a User Type to show User Groups *" : ""}  columns='8' divStyle={{ width: 'auto', paddingRight: '0px', color: 'red' }} />
