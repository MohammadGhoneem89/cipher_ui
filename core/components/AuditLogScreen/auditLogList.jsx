    ...
    if (this.props.AuditLogListData.data) {
      ...
      return (
        <div>
          ...
          <div className="row">
            <div className="col-md-12">
              <Table title={utils.getLabelByID("AuditLogList")} fontclass=""
                     TableClass="portlet light bordered sdg_portlet"
                     gridColumns={utils.getGridColumnByName("auditLogListData")}
                     gridData={this.props.AuditLogListData.data.searchResult || []}
                     totalRecords={this.props.AuditLogListData.pageData.totalRecords}
