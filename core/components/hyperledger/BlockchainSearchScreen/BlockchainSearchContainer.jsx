...
class ConsortiumSearchContainer extends React.Component {
    ...
    render() {
        if (!this.state.isLoading && this.state.consortiumList){
            return (
                <div>
                    <Portlet title={utils.getLabelByID("Consortium")}>
                        <ConsortiumFilterForm onSubmit={this.submit} initialValues={this.state.filterCriteria}
                                          state={this.state}/>
                    </Portlet>
                    <Portlet title={utils.getLabelByID("ConsortiumList")} isPermissioned={true} actions={this.state.consortiumList.data.actions}>
                        <Table
                            pagination={true}
                            export={true}
                            search={false}
...
ConsortiumSearchContainer.displayName = "BlockchainSearch_Heading";
