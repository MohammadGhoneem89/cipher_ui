                ...
                <div className="form-body ">
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="form-group col-md-8">
                        <select id="type" name="type" disabled={flag} onChange={onInputChange}
                                value={initState.smartContractData.type} className="form-control">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="form-group col-md-8">
                        <select id="channelID" name="channelID" disabled={flag} onChange={onInputChannel}
                                value={initState.smartContractData.channelID} className="form-control">
                          <option key="" value="">--select--</option>
                          {
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="form-group col-md-8">
                        <input className="form-control" name="smartContract" disabled={flag}
                               value={initState.smartContractData.smartContract} onChange={onInputChange}
                               type="text"></input>
                      </div>
                    </div>
                    <div className="col-md-6">
                      ...
                      <div className="form-group col-md-8">
                        <input className="form-control" name="smartContractVersion"
                               value={initState.smartContractData.smartContractVersion} onChange={onInputChange}
                               type="text"></input>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="form-group col-md-4">
                        <label className="control-label">{utils.getLabelByID("language")}</label>
                      </div>
                      <div className="form-group col-md-8">
                        <select id="language" name="language" onChange={onInputChange}
                                value={initState.smartContractData.language} className="form-control">
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="form-group col-md-8">
                        <input className="form-control" name="smartContractMethod"
                               value={initState.smartContractData.smartContractMethod} onChange={onInputChange}
                               type="text"></input>
                      </div>
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12">
                      <div className="col-md-12">
                        <textarea type="text" className="form-control" name="smartContractArgs"
                                  value={initState.smartContractData.smartContractArgs} onChange={onInputChange}
                                  rows="4" style={{resize: "none", width: "100%"}}/>
                      </div>
                    </div>
                  </div>
                  <div className="row" style={{marginTop: "20px"}}>
                    ...
                    <div className="col-md-12">
                      <div className="col-md-12">
                        <textarea type="text" className="form-control" name="endorsementPolicy"
                                  value={initState.smartContractData.endorsementPolicy} onChange={onInputChange}
                                  rows="4" style={{resize: "none", width: "100%"}}/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12">
                      <div className="form-group col-md-12">
                                                <textarea disabled className="form-control" id="createstatus"
                                                          value={initState.smartContractData.status} rows="8" cols="150"
                                                          type="text">
