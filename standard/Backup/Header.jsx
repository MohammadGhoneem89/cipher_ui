    ...
    render() {
        return (
            <div className="page-header-inner ">
                ...
                <img src="../../assets/layouts/layout2/img/sdg_emblm.png" alt="logo" className="logo-close"/>
                    <a href="javascript:;" onClick={this.navigate.bind(this, "/entityWorkboard")}>
                        <img src="../../assets/layouts/layout2/img/logo-default.png" alt="logo"
                             className="logo-default"/> </a>
                    ...
                    <div className="top-menu">
                        <ul className="nav navbar-nav pull-right">
                            <li style={{
                                ...
                                <span id="lblLoginInfo"
                                      className="m-r-sm text-muted welcome-message">Last Login: {this.getCurrentDateTime()}</span>
                            </li>
                            ...
                            <li className="dropdown dropdown-extended dropdown-notification"
                                ...
                                <ul className="dropdown-menu">
                                    <li className="external">
                                        <h3>
                                            <span
                                                className="bold">{this.getNotificationCount()} {utils.getLabelByID("header_pending")}</span> {utils.getLabelByID("Notifications_Heading")}
                                        </h3>
                                        <a href="javascript:;"
                                           onClick={this.navigate.bind(this, "/notification")}>{utils.getLabelByID("header_view_all")}</a>
                                    </li>
                                    <li>
...

                                            {
                                                this.props.notifications.data.map((sd, index) => {
                                                    return <li key={index.toString()}>
                                                        <a href="javascript:;" style={{textDecorations: "none"}}
                                                           onClick={this.navigate.bind(this, sd.action)}>
                                                            <span
                                                                className="time">{this.calculateNotificationTime(sd.createdAt)}</span>
                            ...
                            <li className="dropdown dropdown-user">
                                <a href="javascript:;" className="dropdown-toggle" data-toggle="dropdown"
                                   data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span
                                        className="username username-hide-on-mobile">{this.context.lang} {this.props.userData.firstName} {this.props.userData.lastName}  </span>
