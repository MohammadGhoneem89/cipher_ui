...
const FormSection1 = ({ error, initialValues, updateState, state, containerProps }) => {
    ...
    for (let i = 0; i < containerProps.organizationType.organizationType.length; i++) {
        let org =
            {
                value: containerProps.organizationType.organizationType[i]["orgType"],
                label: containerProps.organizationType.organizationType[i]["orgType"]
            }
        orgType.push(org)
    ...
    function updatOrgTypeType(e) {
        updateState({ orgType: e.target.value });
    }
    ...
    return (
        <div>
                ...
                <div className="col-md-6 col-sm-6">
                    ...
                    {userType != 'Entity' && userType != 'Acquirer' &&
                        <DropdownInput name="orgType" options={orgType}
                            label="Organization Type" onChange={updatOrgTypeType}
            ...
            {state.orgType != "" && containerProps.organizationType[state.orgType] &&

                <div className="row">

                    <div className="col-md-6 col-sm-6">
                        <DropdownInput name="orgCode" options={containerProps.organizationType[state.orgType] || []}
                            label={state.orgType} />
                    </div>
                </div>                
            }
            ...
            <div className="row">
                ...
                <div className="col-md-6 col-sm-6">
                    <DropdownInput name="passwordHashType" options={passwordHashType} disabled={containerProps.userID ? true : false}
                        label="Password Type" />
                </div>
        ...
        return (
            <div>
                ...
                <form autoComplete="off" role="form" onSubmit={handleSubmit(this.submit)}>
                    <FormSection1 initialValues={initialValues} updateState={this.updateState} state={this.state} containerProps={containerProps} />
