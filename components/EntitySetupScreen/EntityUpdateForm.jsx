        ...
        <div>
                    ...
                    <div className="row" style={{display: "inline"}}>
                        ...
                        <div className="col-md-5 col-sm-5" style={{textAlign: "center"}}>
                            ...
                            <div className="col-md-12 col-sm-12" style={{textAlign: "center"}}>
                                ...
                                <TextInput name="entityLogo" id='ImgUploader' type='file' style={{display: "none"}}/>
                            </div>}
                        </div>
                    </div>
                </div>
            ...
            <div className="row" style={{padding: "15px"}}>
                <div className="col-md-12 col-sm-12">
                    <Portlet title={utils.getLabelByID("Services")} actions={state.readOnly ? false : servicesActions}>
                        <Table
                            pagination={false}
                            export={false}
                            search={false}
        ...
        <div className="row" style={{padding: "15px"}}>
            ...
            <div className="col-md-3 col-sm-3">
                <DropdownInput name="commissionTemplate" options={containerState.commissionTemplateNames}
                               ...
                               disabled={state.readOnly}
                />
                {state.commissionTemplateID && <a href="javascript:" onClick={() => {
...
const FormSection3 = ({initialValues, updateState, state}) => {
    ...
    let settlementCriteria = [
        {value: "2WAY", label: utils.getLabelByID("TwoWay")},
        {value: "3WAY", label: utils.getLabelByID("ThreeWay")}
    ];
    return (
        <div className="row" style={{padding: "15px"}}>
            <div className="col-md-3 col-sm-3">
